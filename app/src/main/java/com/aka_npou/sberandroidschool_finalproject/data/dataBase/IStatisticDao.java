...
public interface IStatisticDao {
     ...
     *
     * @return {@link TotalStatisticEntity} общая статистика ответов
     */
    @Query("SELECT " +
    ...
    /**
     * Получение списка детализированных результатов ответов на вопросы за заданный период
     *
     * @param from период с в миллисекундах
     * @param to   период по в миллисекундах
     * @return список {@link List} из {@link DetailedStatisticPerPeriodEntity} детализированных результатов
     */
    @Query("SELECT " +
            "qt.type, " +
            "COUNT(s.id) AS countQuestions, " +
