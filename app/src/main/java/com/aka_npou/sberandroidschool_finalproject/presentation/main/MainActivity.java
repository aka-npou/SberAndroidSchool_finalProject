...
import com.aka_npou.sberandroidschool_finalproject.data.dataSource.inClassDataBase.InClassStatisticDataBaseApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IQuestionDataBaseApi questionDataBaseApi = new InClassQuestionDataBaseApi(dataBase);
        IQuestionRepository questionRepository = new QuestionRepository(questionDataBaseApi);
        mQuestionInteractor = new QuestionInteractor(questionRepository);

        IStatisticDataBaseApi statisticDataBaseApi = new InClassStatisticDataBaseApi(dataBase);
        IStatisticRepository statisticRepository = new StatisticRepository(statisticDataBaseApi);
    ...
    private void showStartFragment() {
        getSupportFragmentManager().beginTransaction()
                .add(R.id.container, SelectTypeGameFragment.newInstance(mFragmentNavigation, schedulersProvider, mQuestionInteractor, mStatisticInteractor), SelectTypeGameFragment.TAG)
                .commit();
    }
}